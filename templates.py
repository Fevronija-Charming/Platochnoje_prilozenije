...
uzor_hudozhnika22="""Георгины(1956), Петухи(1957), Розы и рябина, Сиян(1962), Кармен(1965),
Золотые Розы(1966), Гладиолусы(1968), Ирисы(1974)Б
Выпуск . РОЗЫ И РЯБИНА (другое название РЯБИНОВАЯ; современное РЯБИНУШКА) ссылка Розы и рябина
...
Землянка, Меленки, Загадка, Завалинка, Золотое кольцо России, Южная ночь, Юбилейный, Летний день, Ручеёк, Лариса, 
Веночки, Браслет, Анюта, Юбилейная, Цыганка Аза, Рябиновая/Рябинушка(1957 пер 2010)
"""
